...
| 🔐 [Identity & Access Engineer](engineering/engineering-identity-access-engineer.md) | OAuth 2.0/OIDC, enterprise SSO/SCIM, passkeys, session architecture | Login and SSO systems, multi-tenant authorization, token lifecycle design |
