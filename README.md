...
| 🎬 [Video Streaming Engineer](engineering/engineering-video-streaming-engineer.md) | HLS/DASH, ffmpeg transcode ladders, CMAF, DRM, CDN, QoE tuning | Adaptive bitrate delivery, low-latency streaming, buffering/QoE optimization |
