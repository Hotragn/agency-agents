...
| 🛠️ [Developer Tooling Engineer](engineering/engineering-developer-tooling-engineer.md) | CLI design, actionable errors, fast startup, scriptable output, distribution | Building internal dev tools and CLIs with great DX, shell completions, golden paths |
