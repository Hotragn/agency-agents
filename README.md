...
| 📈 [Data Visualization Engineer](engineering/engineering-data-visualization-engineer.md) | Chart-type selection, perceptually honest encodings, colorblind-safe palettes, D3/canvas/WebGL performance | Building charts and dashboards that read fast and honestly, accessible viz, large-dataset rendering |
