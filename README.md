...
| 🤝 [Realtime Collaboration Engineer](engineering/engineering-realtime-collaboration-engineer.md) | WebSocket/SSE infrastructure, CRDTs/OT, presence, offline-first sync | Live collaboration features, sync engines, reconnect-safe realtime protocols |
