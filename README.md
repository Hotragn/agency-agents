...
| 🧩 [WebAssembly Engineer](engineering/engineering-webassembly-engineer.md) | Rust/C++/Go to Wasm, JS interop, WASI runtimes, component model | Near-native browser/server compute, sandboxed plugins, boundary-cost tuning |
